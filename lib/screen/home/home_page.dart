...
import 'package:homework2/models/categoryButton.dart';
          ...
          children: [
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Image.asset('assets/images/cancel.png', width: 40.0),
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  SizedBox(width: 30.0),
                  Expanded(child: CategoryButton(name: 'Unlock all Limitations',
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Expanded(child: CategoryButton(name: 'All Topic Available',
                      image: 'assets/images/book2.png')),
                  SizedBox(width: 30.0),
                  Expanded(child: CategoryButton(name: 'Personlized Coaching',
              ...
              children: [
                Padding(
                  ...
                  child: Text('2021 Special Early Birds Offer',
                      style: TextStyle(color: Color(0xFFF19393),
                ...
                Padding(
                  ...
                  child: Text('View all Plan', style: TextStyle(
